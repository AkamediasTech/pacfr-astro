...
const CarouselDemoFormIsland = ({ steps }) => {
    ...
    return (
        <div class="flex flex-col gap-8 px-6 pt-8 pb-8 md:px-10">
            <header class="grid grid-cols-2 gap-4 md:grid-cols-4">
                {steps.map((step, index) => {
                    ...
                    if (isActive) {
                        ...
                        circleClasses.push(
                            "border-[#0097B2] bg-white text-[#0097B2]"
                        );
                    } else {
                        circleClasses.push(
            ...
            <footer class="flex items-center justify-between">
                ...
                <button
                    type="button"
                    class="cursor-pointer rounded-full border border-slate-200 bg-white px-5 py-2 text-sm font-semibold text-slate-500 transition hover:border-teal-300 hover:text-teal-500 disabled:cursor-not-allowed disabled:opacity-40"
                ...
                <button
                    type="button"
                    class="cursor-pointer rounded-full bg-[#0097B2] px-6 py-2 text-sm font-semibold text-white shadow-lg shadow-teal-500/30 transition hover:bg-[#0097B2] disabled:cursor-not-allowed disabled:opacity-40"
                    onClick={() =>
                        isFinalField ? handleFinalize() : advance("next")
                    }
