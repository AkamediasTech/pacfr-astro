...
const PhaseSummary: FunctionalComponent<PhaseSummaryProps> = ({
  ...
  <div class="mt-12 flex flex-col items-center gap-6 text-center">
    ...
    <div>
      ...
      <p class="mt-2 text-sm text-slate-500">{isFinal ? finalMessage : nextPhaseMessage}</p>
    </div>

    {isFinal ? (
      <button type="button" onClick={onReset} class="btn btn-success btn--glow px-6 py-3 hover:cursor-pointer">
